...
one_one.textContent = 2;
one_two.textContent = 7;
one_three.textContent = 8;
one_four.textContent = 3;
one_five.textContent = 6;
one_six.textContent = 4;
one_seven.textContent = 1;
one_eight.textContent = 9;
one_nine.textContent = 5;

two_one.textContent = 5;
two_two.textContent = 1;
two_three.textContent = 3;
two_four.textContent = 9;
two_five.textContent = 7;
two_six.textContent = 8;
two_seven.textContent = 2;
two_eight.textContent = 4;
two_nine.textContent = 6;

three_one.textContent = 9;
three_two.textContent = 6;
three_three.textContent = 4;
three_four.textContent = 5;
three_five.textContent = 1;
three_six.textContent = 2;
three_seven.textContent = 7;
three_eight.textContent = 3;
three_nine.textContent = 8;

four_one.textContent = 7;
four_two.textContent = 5;
four_three.textContent = 6;
four_four.textContent = 4;
four_five.textContent = 9;
four_six.textContent = 1;
four_seven.textContent = 8;
four_eight.textContent = 2;
four_nine.textContent = 3;

five_one.textContent = 8;
five_two.textContent = 3;
five_three.textContent = 1;
five_four.textContent = 2;
five_five.textContent = 5;
five_six.textContent = 7;
five_seven.textContent = 4;
five_eight.textContent = 6;
five_nine.textContent = 9;

six_one.textContent = 4;
six_two.textContent = 2;
six_three.textContent = 9;
six_four.textContent = 6;
six_five.textContent = 8;
six_six.textContent = 3;
six_seven.textContent = 5;
six_eight.textContent = 7;
six_nine.textContent = 1;

seven_one.textContent = 3;
seven_two.textContent = 8;
seven_three.textContent = 2;
seven_four.textContent = 1;
seven_five.textContent = 4;
seven_six.textContent = 9;
seven_seven.textContent = 6;
seven_eight.textContent = 5;
seven_nine.textContent = 7;

eight_one.textContent = 6;
eight_two.textContent = 9;
eight_three.textContent = 7;
eight_four.textContent = 8;
eight_five.textContent = 2;
eight_six.textContent = 5;
eight_seven.textContent = 3;
eight_eight.textContent = 1;
eight_nine.textContent = 4;

nine_one.textContent = 1;
nine_two.textContent = 4;
nine_three.textContent = 5;
nine_four.textContent = 7;
nine_five.textContent = 3;
nine_six.textContent = 6;
nine_seven.textContent = 9;
nine_eight.textContent = 8;
nine_nine.textContent = 2;
